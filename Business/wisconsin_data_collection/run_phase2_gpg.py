#!/usr/bin/env python3
"""
GPG-Encrypted Google Places Phase 2 Collection Runner
====================================================

Runs Phase 2 collection with GPG-encrypted API key security
"""
...
def run_phase2_collection():
    """Run Phase 2 collection using encrypted API key"""
    print("=" * 60)
    print("GPG-ENCRYPTED GOOGLE PLACES PHASE 2 COLLECTION")
    print("=" * 60)
    print()
    ...
    try:
        ...
        print(f"✓ Phase 2 search areas: {len(collector.phase2_search_areas)}")
        print()
        print("Starting Phase 2 data collection...")
        print("Counties:")
        print("- Winnebago County (Oshkosh, Neenah, Menasha): 9 areas")
        print("- Eau Claire County (Eau Claire): 9 areas")
        print("- Marathon County (Wausau): 9 areas")
        print("- Kenosha County (Kenosha): 8 areas")
        print("- Racine County (Racine): 9 areas")
