#!/usr/bin/env python3
"""
Verify Combined Phase 1 + Phase 2 Google Places Data in BigQuery
"""
...
def main():
    ...
    WHERE county_name IN ('Milwaukee', 'Dane', 'Brown', 'Winnebago', 'Eau Claire', 'Marathon', 'Kenosha', 'Racine')
    ...
    print('=== COMBINED GOOGLE PLACES DATA (PHASE 1 + PHASE 2) ===')
    current_county = None
    county_totals = {}
